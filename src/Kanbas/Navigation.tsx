...
import { Link } from "react-router-dom";  // 确保引入 Link 组件
...
export default function KanbasNavigation() {
  return (
    <div id="wd-kanbas-navigation" style={{ width: 120 }} 
      ...
      <Link to="/Kanbas/Settings" id="wd-settings-link" className="list-group-item text-white bg-black text-center border-0">
